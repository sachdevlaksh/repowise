...
WikiCode providers. Built-in providers are in `packages/core/src/wikicode/core/providers/`.
...
The short version:
1. Create `packages/core/src/wikicode/core/providers/my_provider.py`
