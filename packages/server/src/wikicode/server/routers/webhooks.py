...
from wikicode.server.deps import get_db_session
from wikicode.server.schemas import WebhookResponse

router = APIRouter(prefix="/api/webhooks", tags=["webhooks"])

_GITHUB_SECRET = os.environ.get("WIKICODE_GITHUB_WEBHOOK_SECRET", "")
_GITLAB_TOKEN = os.environ.get("WIKICODE_GITLAB_WEBHOOK_TOKEN", "")
