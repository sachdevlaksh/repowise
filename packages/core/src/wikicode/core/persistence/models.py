"""SQLAlchemy ORM models for WikiCode persistence layer.
...
wikicode.core.ingestion.models.Symbol in files that import from both modules.
"""
...
class WikiSymbol(Base):
    ...
    wikicode.core.ingestion.models.Symbol in files that import both.
    """
