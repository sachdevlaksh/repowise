"""Gemini embedding support for WikiCode semantic search.
...
WikiCode vector store (InMemoryVectorStore, LanceDBVectorStore, PgVectorStore).
...
class GeminiEmbedder:
    """Gemini embedding model adapter implementing the WikiCode Embedder protocol.
