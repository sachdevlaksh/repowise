"""Base provider interface and response types for WikiCode's LLM abstraction layer.

WikiCode is model-agnostic by design. Any LLM — cloud or local — that implements
...
class BaseProvider(ABC):
    ...
    WikiCode is model-agnostic. Any LLM that implements this interface
    ...
    async def generate(
        ...
        Args:
            ...
            temperature:   Sampling temperature. 0.0 is fully deterministic.
                           WikiCode uses 0.3 for consistent doc style.
