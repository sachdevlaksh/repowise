"""Provider registry for WikiCode.
...
enabling community-contributed providers without forking WikiCode.
...
from wikicode.core.rate_limiter import PROVIDER_DEFAULTS, RateLimitConfig, RateLimiter
...
# This means `pip install wikicode-core` without anthropic installed still works —
# you just can't use the anthropic provider.
_BUILTIN_PROVIDERS: dict[str, tuple[str, str]] = {
    "anthropic": ("wikicode.core.providers.anthropic", "AnthropicProvider"),
    "openai": ("wikicode.core.providers.openai", "OpenAIProvider"),
    "gemini": ("wikicode.core.providers.gemini", "GeminiProvider"),
    "ollama": ("wikicode.core.providers.ollama", "OllamaProvider"),
    "litellm": ("wikicode.core.providers.litellm", "LiteLLMProvider"),
    "mock": ("wikicode.core.providers.mock", "MockProvider"),
}
