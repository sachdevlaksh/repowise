...
_BUILTIN_PROVIDERS: dict[str, tuple[str, str]] = {
    "anthropic": ("repowise.core.providers.anthropic", "AnthropicProvider"),
    "openai": ("repowise.core.providers.openai", "OpenAIProvider"),
    "gemini": ("repowise.core.providers.gemini", "GeminiProvider"),
    "ollama": ("repowise.core.providers.ollama", "OllamaProvider"),
    "litellm": ("repowise.core.providers.litellm", "LiteLLMProvider"),
    "mock": ("repowise.core.providers.mock", "MockProvider"),
}
