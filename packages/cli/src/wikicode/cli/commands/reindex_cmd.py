"""``wikicode reindex`` — rebuild vector embeddings from existing wiki pages."""
...
async def _reindex(repo_path, embedder_name: str, batch_size: int) -> None:
    ...
    from wikicode.core.persistence.models import Page
    ...
    from wikicode.core.persistence.models import DecisionRecord
    ...
    if total == 0:
        console.print("[yellow]Nothing to index. Run 'wikicode init' first.[/yellow]")
